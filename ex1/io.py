...
for x in range(1, 20, 5):
    print('{} * {} = {}'.format(str(x).rjust(3), str(x).zfill(3),
                                str(x*x).zfill(3).center(10)))
...
print("Type conversion with '!': {1!a} {2!s} {0}".format(
    '하나abcde', item1, item2))
...
print("Using '+' and '-': {:+5} and {:+5} vs {:-5} and {:-5}".format(
    10, -10, 10, -10))
...
print("decimal:{} binary:{:b} octal:{:o} hexa:{:x} ascii:{:c}".format(
    65, 65, 65, 65, 65))

# number notations: floatig point numbers
num = 3.14159
print("floating:{:.2} exponential:{:e} percentage:{:.3%}".format(
    num, num, num))
